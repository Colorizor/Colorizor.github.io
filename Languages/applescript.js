(function() {
  ...
  var regex = [
    ...
    ['<span id="parameter">$&</span>', /\b(alias|application|boolean|class|constant|date|file|integer|list|number|real|record|string|text|activate|beep|count|delay|launch|log|offset|read|round|run|say|summarize|write|character|characters|contents|day|frontmost|item|length|month|name|paragraph|paragraphs|rest|reverse|running|time|version|weekday|word|words|year)\b/igm],
