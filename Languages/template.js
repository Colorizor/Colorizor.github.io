(function() {
  const data = {
    ...
    execute: [
      ...
      {
        custom: /\b(Array|Date|eval|function|hasOwnProperty|Infinity|isFinite|isNaN|isPrototypeOf|length|Math|NaN|name|Number|Object|prototype|String|toString|undefined|valueOf)\b/igm,
        pat: /.+/igm,
        rep: '<span id="reserved">$&</span>'
      },
      {
        custom: /\b(onblur|onclick|onerror|onfocus|onkeydown|onkeypress|onkeyup|onmouseover|onload|onmouseup|onmousedown|onsubmit)\b/igm,
        pat: /.+/igm,
