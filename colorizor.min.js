var clz = (function() {
  ...
  function BeginEnd(begin, end, pat, rep) {
    ...
    var result,
        ...
        fullCode = code;
    //Colorize
    fullCode = fullCode.replace(reg, function(match) {
      var cut = match.replace(regCutBegin, '').replace(regCutEnd, '');
      return cut.replace(pat, rep);
    });
    /*while ((result = reg.exec(code)) !== null) {
      if (!Contain(matches, result[0])) {
        ...
        fullCode = fullCode.replace(new RegExp(Escape(cut), 'gm'), temp);
      }
    }*/
    code = fullCode;
  }
  ...
  function NotBeginNotEnd(begin, end, pat, rep) {
    ...
    while ((result = reg.exec(code)) !== null) {
      if (!Contain(matches, result[0])) {
        ...
        fullCode = fullCode.replace(new RegExp(Escape(result[0]), 'gm'), temp);
      }
    }
    code = fullCode;
  }
